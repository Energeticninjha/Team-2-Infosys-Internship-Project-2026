...
public class RouteService {
    ...
    public List<RouteOption> calculateRoutes(RouteRequest request) {
        ...
        try {
            ...
            String url = String.format(
                    "http://router.project-osrm.org/route/v1/driving/%f,%f;%f,%f?overview=full&geometries=geojson&alternatives=true",
    ...
    private List<double[]> interpolate(double lat1, double lng1, double lat2, double lng2, int steps,
            double curveFactor) {
        List<double[]> path = new ArrayList<>();
