...
const HealthAnalytics = () => {
    ...
    const handleMaintenance = async (id) => {
        try {
            await axios.put(`http://localhost:8083/api/vehicles/maintenance/reset/${id}`);
    ...
    return (
        <div className="animate-fade-in">
            ...
            <Card noPadding>
                <div className="p-3 border-bottom"><h5 className="mb-0 fw-bold">🚨 Maintenance Alerts & Diagnostics</h5></div>
